...
function wrapConcreteTypes(returnType, targetSchema, document) {
    ...
    return (0, graphql_1.visit)(document, (0, graphql_1.visitWithTypeInfo)(typeInfo, {
        ...
        [graphql_1.Kind.FIELD]: (node) => {
            ...
            type = (0, graphql_1.isNonNullType)(type) ? type.ofType : type;
            if (type != null &&
                (0, graphql_1.isAbstractType)((0, graphql_1.getNamedType)(type)) &&
                (!(0, graphql_1.isUnionType)(type) || type.name === '_Entity') // unnecessary spread on union types, except for federation's "_Entity" (https://www.apollographql.com/docs/federation/subgraph-spec/#union-_entity)
            ) {
                return {
                    ...node,
                    selectionSet: {
