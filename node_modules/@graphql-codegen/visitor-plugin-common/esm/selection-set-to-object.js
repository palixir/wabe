...
import { DeclarationBlock, getFieldNodeNameValue, getPossibleTypes, hasConditionalDirectives, hasIncrementalDeliveryDirectives, mergeSelectionSets, separateSelectionSet, } from './utils.js';
    ...
    _buildGroupedSelections() {
        ...
        if (!this._config.mergeFragmentTypes || this._config.inlineFragmentTypes === 'mask') {
            const grouped = possibleTypes.reduce((prev, type) => {
                ...
                prev[typeName] ||= [];
                const { incrementalNodes, selectionNodes } = allNodes.reduce((acc, node) => {
