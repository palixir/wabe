...
export default defineConfig({
	...
	head: [
		...
		'<meta property="og:title" content="Your backend without vendor lock-in in Typescript">',
		...
		'<meta property="twitter:description" content="Your backend without vendor lock-in in Typescript">',
	...
	themeConfig: {
		...
		sidebar: {
			'/wabe/': [
				...
				{ text: 'Mutex', link: '/documentation/mutex' },
